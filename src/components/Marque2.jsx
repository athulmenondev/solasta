    ...
    return (
        <section className='flex flex-col relative h-[12rem] pt-6 overflow-hidden'>
            ...
            <div className='marquee3 font-chakra tracking-widest text-main_primary/50'>
                <h1 className="text font-black textStroke text-transparent">{siteConfig.eventName} RELOADED</h1>
                <h1 className="text font-black">{siteConfig.eventName} RELOADED</h1>
                <h1 className="text font-black textStroke text-transparent">{siteConfig.eventName} RELOADED</h1>
                <h1 className="text font-black">{siteConfig.eventName} RELOADED</h1>
                <h1 className="text font-black textStroke text-transparent">{siteConfig.eventName} RELOADED</h1>
                <h1 className="text font-black">{siteConfig.eventName} RELOADED</h1>
